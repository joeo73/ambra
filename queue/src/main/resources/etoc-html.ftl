  ...
  <tr>
    <td>
      <div style="border: 1px solid rgb(204, 204, 204); margin: 3px 0px; padding: 3px; font-size: 9px; text-align: center; color: rgb(153, 153, 153); background-color: rgb(238, 238, 238);">
        ...
        <a href="http://www.plosone.org/alerts" title="Change/Discontinue E-mail Alerts">Click here to change or discontinue your alerts.</a></div>
      ...
      <div style="border: 1px solid rgb(204, 204, 204); margin: 3px 0px; padding: 3px; font-size: 9px; text-align: center; color: rgb(153, 153, 153);
          background-color: rgb(238, 238, 238);">Add <a href="mailto:news@lists.plos.org">news@lists.plos.org</a> to your safe senders list in your e-mail address book. Doing so ensures that our e-mails reach your Inbox. Thank you.</div>
        ...
        <tr>
          ...
          <td valign="top">
            ...
            <div style="border: 1px solid rgb(204, 204, 204); margin: 3px 0px; padding: 3px; font-size: 9px; text-align: center; color: rgb(153, 153, 153); background-color: rgb(238, 238, 238);">
              ...
              <p>You can <a title="Change/Discontinue E-mail Alerts" href="http://www.plosone.org/alerts">change or discontinue your alerts</a>  at any time by modifying your profile.</p>
